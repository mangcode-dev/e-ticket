...
<!-- #MAIN PANEL -->
		<div id="main" role="main">
			...
			<!-- #MAIN CONTENT -->
				...
				<!-- end col -->
				<?php echo form_open('quotation3/add/', array('id'=>'smart-form-register', 'class'=>'form-horizontal'));?>
...
<!-- 
											...
											<tbody>
												...
												<tr id="tr1">
													<td class="hidden-480" style="text-align:center;" width="10%">
														<!-- <span class="vbar"></span> -->
																		...
																		<button class='btn btn-minier btn-danger btn-sm ' onclick="delDescription(this.id)" id="1"><i class='ace-icon fa fa-trash-o bigger-30' ></i>ลบรายการ</button>
													</td>
													<td style="text-align:center;" id="td1">
														1
													</td>
													<td style="text-align:center;" width="30%" >
													<!-- <div> -->
														<select class="chosen-select form-control" id="des1" name="des1" data-placeholder="Choose a State..." style="text-align-last:center;" onchange="changeFunc(this.id);">
												...
												<tr id="ttte">
													<td colspan="6" style="text-align:center;">
														...
														<button type="button" class="btn btn-minier btn-success" name="additem" id="additem"><i class="ace-icon glyphicon glyphicon-plus"></i>
															เพิ่มรายการ</button>
														
															<input type="hidden" id="numrow" name="numrow" />
										...
										<table id="tbDetail" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th style="text-align:center;" width="75%">รายละเอียด</th>
											...
											<?php for ($i=1; $i < 11; $i++) { ?>
												<tr >
													<!-- <td class="center" id="chk_id<?php echo $i;?>">
														<label class="pos-rel">
															<input type="checkbox" class="ace" />
															<span class="lbl"></span>
														</label>
													...
													<td id="des_id<?php echo $i;?>">
														
													</td>
													<td id="value_id<?php echo $i;?>">
														<input type="text" name="txt_value<?php echo $i;?>" id="txt_value<?php echo $i;?>" placeholder="" class="width-100"  />
													</td>
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<div class="clearfix form-actions">
												...
												<input type="hidden" name="action" value="<?php echo base64_encode('addQuotation');?>"  />
		...
		<script type="text/javascript">
		    $(window).load(function(){
		        ...
		        document.getElementById('des_id1').innerHTML = "Service Order";
		        document.getElementById('des_id2').innerHTML = "ประเภทบริการ";
		        document.getElementById('des_id3').innerHTML = "ต้นทาง";
		        document.getElementById('des_id4').innerHTML = "ปลายทาง";
		        document.getElementById('des_id5').innerHTML = "Delivery Time";
		        document.getElementById('des_id6').innerHTML = "เงื่อนไขการชำระเงิน";
		        document.getElementById('des_id7').innerHTML = "ระยะเวลาการใช้บริการ";
		        document.getElementById('des_id8').innerHTML = "เงื่อนไขและระเบียบการใช้บริการ";
		        document.getElementById('des_id9').innerHTML = "ผู้เสนอราคา";
		        document.getElementById('des_id10').innerHTML = "พยาน";
		    });
		</script>
				        ...
				        $.ajax({
							...
							success:function(data) {
									...
									if (data.value.reference_default.bidder1.value==null||data.value.reference_default.bidder1.value=='') {
										...
										$('#txt_value9').val(data.value.reference_default.bidder1.value);
									}

									if (data.value.reference_default.bidder2.value==null||data.value.reference_default.bidder2.value=='') {
										$('#txt_value10').val(" - ");
									}else{
										$('#txt_value10').val(data.value.reference_default.bidder2.value);
									}
		...
		<script type="text/javascript">
			$("#additem").click(function () {   
			    ...
			    var test1 = "<button class='btn btn-minier btn-danger btn-sm' id='"+no+"' onclick='delDescription(this.id)  '><i class='ace-icon fa fa-trash-o bigger-30 '></i>ลบรายการ</button>";
			    var des = "<select class='chosen-select form-control' id='des"+no+"' name='des"+no+"' data-placeholder='Choose a State...' style='text-align-last:center;' onchange='changeFunc(this.id);'><option value='0' >  -- กรุณาเลือกรายระเอียด --  </option><?php
			    ...
			    var rowsnum = ($('#myTable tr').length)-2;

			    // console.log(rowsnum);
			    document.getElementById("numrow").value = rowsnum;

		    });


		  function delDescription($ino) {
		  	try{
			   ...
			   // console.log(temp);
    			...
    			for (var i = temp; i < table.rows.length; i++) {
    				alert(i);

    					document.getElementById("tr"+i).setAttribute('id',"tr"+(i-1));
    					document.getElementById("td"+i).setAttribute('id',"td"+(i-1));
    					document.getElementById(i).setAttribute('id',(i-1));
		    			document.getElementById("des"+i).setAttribute('id',"des"+(i-1));
		    			document.getElementById("quantity"+i).setAttribute('id',"quantity"+(i-1));
		    			document.getElementById("price"+i).setAttribute('id',"price"+(i-1));
		    			document.getElementById("total"+i).setAttribute('id',"total"+(i-1));
		    			document.getElementById("unit"+i).setAttribute('id',"unit"+(i-1));
		    			document.getElementById("totalall"+i).setAttribute('id',"totalall"+(i-1));

    					document.getElementById("td"+i).value = "df";
    			}
    			
    			document.getElementById("td4").value = "3";
    			
    			// for (var i = temp; i <= no; i++) {
    			...
    			// document.getElementById("td3").value = "sdq";
   				 // console.log(table);
		   ...
		   <!-- <script type="text/javascript">
		     ...
		     <script type="text/javascript">
				    ...
				    $(function(){
				      ...
				      $("#txt_cust").autocomplete({
				      source: function(request, response) {
				        $.ajax({
				           //เรียกไฟล์ที่ต้องการมาแสดงที่หน้า autocomplete ในที่นี้คือ controller ชื่อ welcome methode ชื่อ search_jquery_autocomplete
				          url:"<?php echo base_url() . "quotation3/searchCust";?>",
				          dataType: "jsonp",
				          data: {
				             //ค่าที่ส่งไปค้นหาที่ <?php echo site_url();?>/welcome/search_jquery_autocomplete
				            q: request.term
				          },
				          success: function( data ) {
				            response(data);
				      ...
				      select: function( event, ui ) {
				        ...
				        $.ajax({
				           //เรียกไฟล์ที่ต้องการมาแสดงที่หน้า autocomplete ในที่นี้คือ controller ชื่อ welcome methode ชื่อ search_jquery_autocomplete
				          url:"<?php echo base_url() . "quotation3/getAddress";?>",
				          dataType: "jsonp",
				          data: {
				             //ค่าที่ส่งไปค้นหาที่ <?php echo site_url();?>/welcome/search_jquery_autocomplete
				            q: ui.item.label
