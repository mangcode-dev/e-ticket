									...
									<div class="col-xs-12">
										...
										<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tr>
													...
													<td style="text-align:center;"> <?php echo date('Y-m-d H:i:s', strtotime($user_detail['date_created']));?></td>
													<td>

													<button type="button" class='btn btn-xs btn-default' data-original-title='Edit' onclick="javascript:window.location='<?php echo base_url().'user/edit/'.$user_detail['su_id'];?>';"><i class='fa fa-pencil'></i></button>

													<button type="button" class='btn btn-xs btn-default' data-original-title='Rule' onclick="javascript:window.location='<?php echo base_url().'user/rule/'.$user_detail['su_id'];?>';"><i class='fa fa-key'></i></button>
														
													<?php

														if($user_detail['enable'] == 1){
													?>
															<button type="button" class='btn btn-xs btn-default' data-original-title='Disable' onclick="javascript:window.location='<?php echo base_url().'user/disable/'.$user_detail['su_id'];?>';"><i class='fa fa-times'></i></button>

													<?php }else{ ?>

														<button type="button" class='btn btn-xs btn-default' data-original-title='Enable' onclick="javascript:window.location='<?php echo base_url().'user/enable/'.$user_detail['su_id'];?>';"><i class='fa fa-check-square-o'></i></button>

													<?php } ?>

														<button type="button" class='btn btn-xs btn-default' data-original-title='Delete' onclick="javascript:if(confirm('คุณต้องการลบรายการนี้ใช่หรือไม่?')){ window.location='<?php echo base_url().'user/delete/'.$user_detail['su_id'];?>'; }else{ return false; }"><i class='fa fa-trash-o'></i></button>
													</td>
