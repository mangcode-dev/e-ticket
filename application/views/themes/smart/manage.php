					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown language-switch">
							<a class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> <img
									src="<?php echo base_url()?>themes/smart/img/flags/gb.png" class="position-left" alt=""> English
							</a>
							<ul class="dropdown-menu">
								<li>
									<a class="deutsch"><img src="<?php echo base_url() ?>themes/smart/img/flags/de.png" alt=""> Deutsch</a>
								</li>
								<li>
									<a class="ukrainian"><img src="<?php echo base_url() ?>themes/smart/img/flags/ua.png" alt=""> Українська</a>
								</li>
								<li>
									<a class="english"><img src="<?php echo base_url()  ?>themes/smart/img/flags/gb.png" alt=""> English</a>
								</li>
								<li>
									<a class="espana"><img src="<?php echo base_url() ?>themes/smart/img/flags/es.png" alt=""> España</a>
								</li>
								<li>
									<a class="russian"><img src="<?php echo base_url() ?>themes/smart/img/flags/ru.png" alt=""> Русский</a>
								</li>
							</ul>
						</li>
						<!-- end language menu -->
								...
								<li>
									<ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?php echo base_url()   ?>themes/smart/img/user/user2.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?php echo base_url()  ?>themes/smart/img/user/user3.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?php echo base_url() ?>themes/smart/img/user/user1.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?php echo base_url() ?>themes/smart/img/user/user8.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
										...
										<li>
											<a href="#">
												<span class="photo">
													<img src="<?php echo base_url()  ?>themes/smart/img/user/user5.jpg" class="img-circle" alt="">
												</span>
												<span class="subject">
						...
						<li class="dropdown dropdown-user">
							<a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
								data-close-others="true">
								<img alt="" class="img-circle " src="<?php echo base_url()  ?>themes/smart/img/dp.jpg" />
					...
					<div id="remove-scroll" class="left-sidemenu">
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false"
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="all_<?php echo base_url()   ?>themes/smart.html" class="nav-link "> <span class="title">All Library
												<?php echo base_url()   ?>themes/smart</span>
										</a>
									</li>
									<li class="nav-item">
											...
											<tbody>
												<tr>
													<td class="patient-img">
														<img src="<?php echo base_url() ?>themes/smart/img/user/user1.jpg" alt="">
													</td>
													<td>John Doe</td>
													<td>Science</td>
													<td>xyz@email.com</td>
												...
												<tr>
													<td class="patient-img">
														<img src="<?php echo base_url()   ?>themes/smart/img/user/user4.jpg" alt="">
													</td>
													<td>Sarah Smith</td>
													<td>Mathematics</td>
													<td>xyz@email.com</td>
												...
												<tr>
													<td class="patient-img">
														<img src="<?php echo base_url()   ?>themes/smart/img/user/user6.jpg" alt="">
													</td>
													<td>Airi Satou</td>
													<td>Music</td>
													<td>xyz@email.com</td>
												...
												<tr>
													<td class="patient-img">
														<img src="<?php echo base_url()  ?>themes/smart/img/user/user5.jpg" alt="">
													</td>
													<td>Ashton Cox</td>
													<td>Dance</td>
													<td>xyz@email.com</td>
												...
												<tr>
													<td class="patient-img">
														<img src="<?php echo base_url()  ?>themes/smart/img/user/user7.jpg" alt="">
													</td>
													<td>Cara Stevens</td>
													<td>Commerce</td>
													<td>xyz@email.com</td>
												...
												<tr>
													<td class="patient-img">
														<img src="<?php echo base_url()   ?>themes/smart/img/user/user8.jpg" alt="">
													</td>
												...
												<tr>
													<td class="patient-img">
														<img src="<?php echo base_url()  ?>themes/smart/img/user/user9.jpg" alt="">
													</td>
													<td>Pooja Sharma</td>
													<td>Science</td>
													<td>xyz@email.com</td>
									...
									<div class="table-responsive">
										<table class="table table-hover">
											<tbody>
												...
												<tr>
													<td class="patient-img">
														<img src="<?php echo base_url() ?>themes/smart/img/user/user10.jpg" alt="">
													</td>
													<td>XY56987</td>
													<td>John Deo</td>
												...
												<tr>
													<td class="patient-img">
														<img src=" <?php echo base_url()  ?>themes/smart/img/user/user3.jpg" alt="">
													</td>
													<td>XY12587</td>
													<td>Sarah Smith</td>
												...
												<tr>
													<td class="patient-img">
														<img src=" <?php echo base_url()   ?>themes/smart/img/user/user2.jpg" alt="">
													</td>
													<td>XY87452</td>
													<td>Sagar Patel</td>
													<td><i class="fas fa-circle col-green me-2"></i>Confirm</td>
									...
									<ul class="feedBody">
										<li class="active-feed">
											<div class="feed-user-img">
												<img src=" <?php echo base_url()  ?>themes/smart/img/user/user1.jpg" class="img-radius "
										...
										<li class="diactive-feed">
											<div class="feed-user-img">
												<img src=" <?php echo base_url() ?>themes/smart/img/user/user2.jpg" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
										...
										<li class="diactive-feed">
											<div class="feed-user-img">
												<img src="<?php echo base_url()  ?>themes/smart/img/user/user3.jpg" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
										...
										<li class="active-feed">
											<div class="feed-user-img">
												<img src="<?php echo base_url()   ?>themes/smart/img/user/user4.jpg" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
										...
										<li class="active-feed">
											<div class="feed-user-img">
												<img src="<?php echo base_url()  ?>themes/smart/img/user/user5.jpg" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
												<span class="feedLblStyle lblFileStyle">File</span> Sarah Smith <small
										...
										<li class="diactive-feed">
											<div class="feed-user-img">
												<img src="<?php echo base_url()   ?>themes/smart/img/user/user6.jpg" class="img-radius "
													alt="User-Profile-Image">
											</div>
											<h6>
												<span class="feedLblStyle lblTaskStyle">Task </span> Jalpa Joshi<small
							...
							<div class="chat-sidebar-list">
								<div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd"
									...
									<ul class="media-list list-items">
										<li class="media"><img class="media-object" src="<?php echo base_url()  ?>themes/smart/img/user/user3.jpg"
										...
										<li class="media">
											...
											</div> <img class="media-object" src=" <?php echo base_url()?>themes/smart/img/user/user1.jpg"
												width="35" height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src=" <?php echo base_url() ?>themes/smart/img/user/user5.jpg"
												width="35" height="35" alt="...">
											<i class="away dot"></i>
											<div class="media-body">
										...
										<li class="media">
											...
											</div> <img class="media-object" src="<?php echo base_url()   ?>themes/smart/img/user/user4.jpg"
												width="35" height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="<?php echo base_url()   ?>themes/smart/img/user/user2.jpg"
												width="35" height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="<?php echo base_url()   ?>themes/smart/img/user/user7.jpg"
												width="35" height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
									...
									<ul class="media-list list-items">
										<li class="media">
											...
											</div> <img class="media-object" src="<?php echo base_url()   ?>themes/smart/img/user/user6.jpg"
												width="35" height="35" alt="...">
										...
										<li class="media"><img class="media-object" src="<?php echo base_url() ?>themes/smart/img/user/user8.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media">
											...
											</div> <img class="media-object" src="<?php echo base_url()   ?>themes/smart/img/user/user9.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="<?php echo base_url()  ?>themes/smart/img/user/user10.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
...
<script src="<?php echo base_url()?>themes/smart/plugins/popper/popper.js"></script>
<script src="<?php echo base_url()?>themes/smart/plugins/jquery-blockui/jquery.blockui.min.js"></script>
<script src="<?php echo base_url()?>themes/smart/plugins/jquery-slimscroll/jquery.slimscroll.js"></script>
<script src="<?php echo base_url()?>themes/smart/plugins/feather/feather.min.js"></script>
<!-- bootstrap -->
<script src="<?php echo base_url()?>themes/smart/plugins/bootstrap/js/bootstrap.min.js"></script>
<script src="<?php echo base_url()?>themes/smart/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
<script src="<?php echo base_url()?>themes/smart/plugins/sparkline/jquery.sparkline.js"></script>
<script src="<?php echo base_url()?>themes/smart/js/pages/sparkline/sparkline-data.js"></script>
<!-- Common js-->
...
<!-- material -->
<script src="<?php echo base_url()?>themes/smart/plugins/material/material.min.js"></script>
<!--apex chart-->
<script src="<?php echo base_url()?>themes/smart/plugins/apexcharts/apexcharts.min.js"></script>
<script src="<?php echo base_url()?>themes/smart/js/pages/chart/apex/home-data.js"></script>
<!-- summernote -->
<script src="<?php echo base_url()?>themes/smart/plugins/summernote/summernote.js"></script>
<script src="<?php echo base_url()?>themes/smart/js/pages/summernote/summernote-data.js"></script>
	<!-- end js include path -->
</body>
