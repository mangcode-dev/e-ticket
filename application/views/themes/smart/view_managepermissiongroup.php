									...
									?>
											<tr>
												...
												<td>
													...
													<button type="button" class='btn btn-danger btn-xs' data-original-title='Delete' onclick="javascript:if(confirm('คุณต้องการลบรายการนี้ใช่หรือไม่?')){ window.location='<?php echo base_url() . 'Permissiongroup/delete/' . $permissiongroup_detail['spg_id']; ?>'; }else{ return false; }"><i class='fa fa-trash-o'></i></button>
												</td>
											</tr>
										<?php $i++;
										}
